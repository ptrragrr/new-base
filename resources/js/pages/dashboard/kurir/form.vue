      ...
      <div class="row">
        <div class="col-md-6">
          <div class="fv-row mb-7">
            ...
            <Field class="form-control form-control-lg form-control-solid" type="text" name="name" v-model="kurir.name"
        ...
        <div class="col-md-6">
          <div class="fv-row mb-7">
            ...
            <Field class="form-control form-control-lg form-control-solid" type="email" name="email" v-model="kurir.email"
        ...
        <div class="col-md-6">
          <div class="fv-row mb-7">
            ...
            <Field class="form-control form-control-lg form-control-solid" type="text" name="phone" v-model="kurir.phone"
        ...
        <div class="col-md-6">
          <div class="fv-row mb-7">
            ...
            <Field class="form-control form-control-lg form-control-solid" type="password" name="password"
              v-model="kurir.password" placeholder="Masukkan Password (opsional saat edit)" />
